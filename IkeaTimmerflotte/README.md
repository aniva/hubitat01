...
![IKEA App Setup](images/matter_setup_code_ikea_app_example.png)

5.  Copy the code generated by the app.

![Copy Code](images/matter_setup_code_ikea_app_copy_example.png)
...
![Hubitat Add Device](images/hubitat_add_matter_device_example.png)

4.  Paste the code you copied from the IKEA app.

![Paste Code](images/hubitat_copy_matter_code_example.png)
